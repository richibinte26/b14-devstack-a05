    ...
    >
      <div className="flex items-center justify-between">
        <img
          ...
          className="h-12 w-12"
        />
        <span className="rounded-full border border-white shadow-sm  bg-white px-3 py-1 text-sm text-sky-500">
          {technology.badge}
        </span>
      </div>
      ...
      <button
        ...
        disabled={isAdded}
        className={`mt-5 w-full rounded-lg py-2.5 text-sm font-medium cursor-pointer disabled:cursor-not-allowed ${
          isAdded
