...
const Footer = () => {
    return(
        <footer className="border-t border-gray-200 bg-white">
            <div className="mx-auto grid w-full gap-10 px-6 py-12 md:grid-cols-2 lg:grid-cols-4">
                <div>
            ...
            <div className="ml-5 mr-14 border-t border-gray-200"></div>
                <div className="mx-auto flex w-full items-center justify-between px-6 py-4 text-sm text-gray-500">
